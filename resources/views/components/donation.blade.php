<div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="w-full relative mt-2 rounded-md shadow-sm">
        <input
            ...
            name="donate"
            id="donate"
            class="block w-full rounded-md border-0 py-1.5 pr-10 text-gray-900 ring-1 ring-inset ring-green-300 focus:ring-2 focus:ring-inset focus:ring-green-900 sm:text-sm sm:leading-6"
